...
export function StayConnectedSection() {
  return (
    <section className="bg-background py-6 lg:py-15">
        ...
        <FadeUp>
          <div className="text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/carnot.research/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2.5 rounded-full border border-pink-200 bg-pink-50 px-4 py-2 text-sm font-medium text-pink-600 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:bg-pink-100 hover:shadow-md"
              >
