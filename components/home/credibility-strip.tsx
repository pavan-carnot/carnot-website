  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <p
          className="mb-8 text-center text-[11px] font-semibold uppercase tracking-widest text-gray-500"
          style={triggered ? { animation: "fadeUpIn 0.4s ease both" } : { opacity: 0 }}
        >
          IIT Delhi · CMMI Level 3 · ISO 27001:2022 · DPIIT Recognised
        </p>
        <div className="grid grid-cols-1 gap-y-8 sm:grid-cols-3 sm:divide-x sm:divide-gray-700/60">
          {stats.map((stat, i) => (
            <StatItem
              key={stat.label}
              stat={stat}
