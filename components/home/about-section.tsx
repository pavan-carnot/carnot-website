...
const images = [
  { src: `${B}/assets/company/who-we-are/Opening_Image_2.jpg`, alt: "Carnot Research lab work" },
  { src: `${B}/assets/company/who-we-are/Opening_Image_3.jpg`, alt: "Carnot Research team" },
]
