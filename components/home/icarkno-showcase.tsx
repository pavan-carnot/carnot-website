...
const icarKnoFeatures = [
  { icon: Layers,        text: "Ingest PDFs, videos, audio, web pages & scanned documents" },
  { icon: FileText,      text: "Answers with verifiable, cited sources — no hallucinations" },
  { icon: Shield,        text: "100% on-premise, air-gap capable, zero cloud dependency" },
  { icon: MessageSquare, text: "Conversational AI with agentic workflows" },
]
  ...
  return (
    <section className="relative overflow-hidden bg-background py-20 lg:py-28">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 1px 1px, rgba(37,99,235,0.055) 1px, transparent 0)",
          backgroundSize: "32px 32px",
        }}
      />
      <div
        className="pointer-events-none absolute -top-40 -left-40 h-[500px] w-[500px] rounded-full bg-blue-500/5 blur-3xl"
        style={{ animation: "float 12s ease-in-out infinite" }}
      />
      <div
        className="pointer-events-none absolute -bottom-40 -right-40 h-[500px] w-[500px] rounded-full bg-cyan-500/4 blur-3xl"
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <FadeUp className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-muted-foreground">
            From enterprise knowledge management to elite sports analytics and public transit
            intelligence — deployed and operational across India today.
          </p>
        </FadeUp>

        {/* ── icarKno deep spotlight ── */}
        <FadeUp delay={80} className="mt-0">
          <div className="relative overflow-hidden rounded-2xl border border-border bg-card">
            <div
              className="h-[3px] w-full"
              style={{ background: "linear-gradient(90deg, #0891b2, #06b6d4, #22d3ee)" }}
            />
        ...
        <div className="mt-6 grid gap-6 sm:grid-cols-2 items-stretch">
          {imageProducts.map((p, i) => (
            <FadeUp key={p.name} delay={200 + i * 100} className="flex">
              <Link
                href={p.href}
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${p.accentFrom}15 0%, ${p.accentTo}0a 100%)`,
                  }}
                >
                  <div
        ...
        {/* ── GeM callout ── */}
        <FadeUp delay={100} className="mt-5">
          <div className="flex flex-col items-start justify-between gap-4 rounded-xl border border-border bg-secondary/40 px-5 py-4 sm:flex-row sm:items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-foreground">
                  Also listed on GeM — Government e-Marketplace
                </p>
            ...
            <Link
              href="/products"
              className="inline-flex shrink-0 items-center gap-1 text-sm font-semibold text-blue-600 hover:underline"
            >
              View all
              <ArrowUpRight className="h-3.5 w-3.5" />
            </Link>
