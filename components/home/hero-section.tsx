...
export function HeroSection() {
  return (
    <section className="relative min-h-[600px] overflow-hidden bg-[#d2e6e4]">
      <VantaGlobeBackground />
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-24 lg:px-8 lg:py-36">
        <div className="mx-auto max-w-3xl text-center">
          <p
            className="mb-4 text-xs font-semibold tracking-widest text-[#1a57eb] uppercase"
          ...
          <p
            className="mx-auto mt-6 max-w-2xl text-pretty text-lg leading-relaxed text-slate-700"
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Button
              size="lg"
              asChild
              className="shadow-lg hover:shadow-xl transition-shadow bg-[#1a57eb] text-white hover:bg-[#1a57eb]/90"
            >
              <Link href="/products">
                Explore Products
            ...
            <Button
              ...
              size="lg"
              asChild
              className="border-2 border-[#1a57eb] bg-transparent text-[#1a57eb] hover:bg-[#1a57eb]/10 hover:border-[#1a57eb]"
            >
